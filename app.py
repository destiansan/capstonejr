...
def index():
	...
	plot_automake_res = plot_automake(data)
	plot_witness_res = plot_witness(data)
	plot_agesex_res = plot_agesex(data)
	plot_citysev_res = plot_citysev(data)
	...
	return render_template('index.html',
		 ...
		 plot_automake_res=plot_automake_res,
		 plot_witness_res=plot_witness_res,
		 plot_agesex_res=plot_agesex_res,
		 plot_citysev_res=plot_citysev_res
		)
